...
public class Arguments extends Command{
    ...
    public void run(String[] args, GuildMessageReceivedEvent e) throws Exception{
        ...
        eb.addField(language.getString("arguments.tokens"), language.getString("arguments.token"), false);
        eb.addField(language.getString("arguments.multiple"), language.getString("arguments.quotes"), false);
        eb.addField(language.getString("help.commands"), language.getString("help.embed.description"), false);
